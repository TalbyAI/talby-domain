...
220 casos coinciden con sus resultados esperados en TypeScript/Node, cel-go y Chrome. Se propone adoptar **CEL acotado, tipos/comparadores del host y RE2JS para patrones** en la primera entrega. La equivalencia comprobada pertenece a este perfil, no a CEL completo ni a cualquier implementación del lenguaje.
...
| --- | --- | --- |
| CEL + RE2JS | 220 casos pasan con `script-src 'self'`, sin permisos para WASM/eval; ninguna petición externa o WASM | Worker: 449 483 bytes; gzip 98 131 bytes, aproximadamente 96 KiB |
